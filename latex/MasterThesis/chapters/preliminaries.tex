...
\begin{lemma}
$$\sum_{v\in V}d^+(v)=\sum_{v\in V}d^-(v)=2\left\vert{A}\right\vert$$
\end{lemma}
...
A truth assignment is a choice of $true$ or $false$ for each variable, i.e., a function $v : X \rightarrow \{true, false\}$.
\end{definition}

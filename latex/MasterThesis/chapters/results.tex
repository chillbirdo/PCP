This chapter provides information about the implementation, testing environment, instances used for evaluation and the computational results of different methods and parameters presented in chapter [TODO] are compared to each other and results of [Li],[Noronha],[exact] . 
...
%TODO insert IN tables
      ...
      ItMax & TabuTenure & $\overline{obj}$ & $sd$ & $\overline{time}$ & $\overline{obj}$ & $sd$ & $\overline{time}$ & $\overline{obj}$ & $sd$ & $\overline{time}$ & $\overline{obj}$ & $sd$ & $\overline{time}$\\
      \hline
      \multirow{6}{*}{1} & $U[0.25C',0.75C']$ & 53.00 & 0.000 & 32.675 & 52.50 & 0.250 & 45.955 & \textbf{52.00} & 0.000 & 41.061 & 52.50 & 0.250 & 131.369 \\
       & $U[0.0C',1.0C']$ & 53.00 & 0.000 & 31.822 & 53.00 & 0.000 & 31.307 & \textbf{52.50} & 0.250 & 38.698 & 53.00 & 0.000 & 124.405 \\
       & $U[0.0C',0.5C']$ & \textbf{52.00} & 0.000 & 49.998 & 52.50 & 0.250 & 40.508 & \textbf{52.00} & 0.000 & 47.886 & 52.50 & 0.250 & 133.227 \\
       & $U[0.5C',1.0C']$ & 52.50 & 0.250 & 34.443 & 52.50 & 0.250 & 34.702 & 53.00 & 0.000 & 34.162 & \textbf{52.00} & 0.000 & 151.490 \\
       & $U[0.25C',1.0C']$ & 53.00 & 0.000 & 33.513 & \textbf{52.50} & 0.250 & 34.969 & 53.00 & 0.000 & 35.207 & 53.00 & 0.000 & 126.708 \\
       & $U[0.0C',0.75C']$ & \textbf{52.50} & 0.250 & 37.164 & \textbf{52.50} & 0.250 & 42.677 & \textbf{52.50} & 0.250 & 43.436 & \textbf{52.50} & 0.250 & 137.571 \\
      \hline\hline
      \multirow{6}{*}{5} & $U[0.25C',0.75C']$ & 52.00 & 0.000 & 175.018 & \textbf{51.50} & 0.250 & 222.313 & 52.00 & 0.000 & 167.028 & 52.00 & 0.000 & 263.785 \\
       & $U[0.0C',1.0C']$ & \textbf{51.50} & 0.250 & 192.997 & 52.00 & 0.000 & 166.878 & 52.00 & 0.000 & 168.842 & 52.00 & 0.000 & 270.638 \\
       & $U[0.0C',0.5C']$ & \textbf{51.50} & 0.250 & 188.598 & \textbf{51.50} & 0.250 & 194.900 & \textbf{51.50} & 0.250 & 234.086 & 52.00 & 0.000 & 267.352 \\
       & $U[0.5C',1.0C']$ & 52.00 & 0.000 & 167.531 & \textbf{51.50} & 0.250 & 197.548 & \textbf{51.50} & 0.250 & 191.290 & \textbf{51.50} & 0.250 & 301.400 \\
      ...
      \multirow{6}{*}{10} & $U[0.25C',0.75C']$ & \textbf{51.00} & 0.000 & 460.830 & \textbf{51.00} & 0.000 & 499.770 & 51.50 & 0.250 & 385.627 & \textbf{51.00} & 0.000 & 580.569 \\
       ...
       & $U[0.5C',1.0C']$ & \textbf{51.00} & 0.000 & 434.163 & 51.50 & 0.250 & 368.134 & \textbf{51.00} & 0.000 & 467.440 & \textbf{51.00} & 0.000 & 617.425 \\
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
      ...
      \multicolumn{2}{|l||}{Parameters}&\multicolumn{3}{|l||}{Random}&\multicolumn{3}{|l||}{OneStepCD}&\multicolumn{3}{|l||}{ILP1}&\multicolumn{3}{|l|}{ILP2}\\
      \cline{1-14}
      TTRecolored & TabuTenure & $\overline{obj}$ & $sd$ & $\overline{time}$ & $\overline{obj}$ & $sd$ & $\overline{time}$ & $\overline{obj}$ & $sd$ & $\overline{time}$ & $\overline{obj}$ & $sd$ & $\overline{time}$\\
      \hline
      \multirow{6}{*}{0.0} & $U[0.0C',0.5C']$ & 10.3 & 0.050 & 0.123 & 10.5 & 0.050 & 0.101 & 10.4 & 0.100 & 0.391 & 10.5 & 0.150 & 0.903 \\
       ...
       & $U[10.0C',20.0C']$ & \textbf{10.0} & 0.000 & 0.149 & \textbf{10.1} & 0.050 & 0.125 & 10.1 & 0.050 & 0.413 & 10.4 & 0.100 & 0.930 \\
      \hline\hline
      \multirow{6}{*}{0.3} & $U[0.0C',0.5C']$ & 10.4 & 0.100 & 0.112 & \textbf{10.4} & 0.200 & 0.117 & 10.7 & 0.150 & 0.349 & \textbf{10.2} & 0.000 & 0.958 \\
      ...
      \caption{pcpn90p7}
      \label{tab:pcpn90p7RecoloredTT}\end{table}
      ...
      TTRecolored & TabuTenure & $\overline{obj}$ & $sd$ & $\overline{time}$ & $\overline{obj}$ & $sd$ & $\overline{time}$ & $\overline{obj}$ & $sd$ & $\overline{time}$ & $\overline{obj}$ & $sd$ & $\overline{time}$\\
      \hline
      \multirow{6}{*}{0.0} & $U[0.0C',0.5C']$ & 12.9 & 0.050 & 0.188 & 12.9 & 0.050 & 0.177 & 13.0 & 0.100 & 0.539 & 12.9 & 0.150 & 1.198 \\
       & $U[0.5C',1.0C']$ & \textbf{12.4} & 0.100 & 0.191 & 12.7 & 0.050 & 0.159 & \textbf{12.5} & 0.050 & 0.604 & 12.8 & 0.000 & 1.208 \\
       & $U[1.0C',4.0C']$ & 12.2 & 0.000 & 0.180 & 12.2 & 0.000 & 0.200 & 12.3 & 0.050 & 0.596 & 12.4 & 0.100 & 1.295 \\
       ...
       & $U[10.0C',20.0C']$ & 12.7 & 0.050 & 0.185 & 12.7 & 0.050 & 0.174 & 12.6 & 0.100 & 0.573 & 12.7 & 0.050 & 1.217 \\
      \hline\hline
      \multirow{6}{*}{0.3} & $U[0.0C',0.5C']$ & 12.9 & 0.050 & 0.177 & 12.8 & 0.100 & 0.196 & \textbf{12.7} & 0.150 & 0.570 & 13.0 & 0.000 & 1.172 \\
       & $U[0.5C',1.0C']$ & 12.6 & 0.000 & 0.172 & \textbf{12.5} & 0.050 & 0.181 & 12.6 & 0.100 & 0.550 & \textbf{12.4} & 0.000 & 1.318 \\
       & $U[1.0C',4.0C']$ & \textbf{12.1} & 0.050 & 0.188 & \textbf{12.1} & 0.050 & 0.197 & \textbf{12.2} & 0.000 & 0.608 & 12.4 & 0.000 & 1.308 \\
       & $U[0.0C',5.0C']$ & 12.2 & 0.100 & 0.173 & 12.3 & 0.050 & 0.180 & \textbf{12.2} & 0.100 & 0.606 & \textbf{12.1} & 0.050 & 1.395 \\
       & $U[5.0C',10.0C']$ & 12.3 & 0.050 & 0.195 & \textbf{12.3} & 0.050 & 0.184 & 12.5 & 0.050 & 0.572 & 12.4 & 0.100 & 1.314 \\
      ...
      \caption{pcpn90p8}
      \label{tab:pcpn90p8RecoloredTT}\end{table}      
      ...
      TTRecolored & TabuTenure & $\overline{obj}$ & $sd$ & $\overline{time}$ & $\overline{obj}$ & $sd$ & $\overline{time}$ & $\overline{obj}$ & $sd$ & $\overline{time}$ & $\overline{obj}$ & $sd$ & $\overline{time}$\\
      \hline
      \multirow{6}{*}{0.0} & $U[0.0C',0.5C']$ & 16.5 & 0.050 & 0.353 & \textbf{16.8} & 0.300 & 0.377 & 16.7 & 0.350 & 0.721 & 17.4 & 0.000 & 1.067 \\
       & $U[0.5C',1.0C']$ & 16.2 & 0.100 & 0.294 & 16.4 & 0.000 & 0.269 & \textbf{16.1} & 0.050 & 0.710 & 16.3 & 0.050 & 1.312 \\
       & $U[1.0C',4.0C']$ & 16.0 & 0.100 & 0.285 & \textbf{15.8} & 0.000 & 0.310 & 16.0 & 0.100 & 0.716 & \textbf{15.9} & 0.050 & 1.442 \\
       & $U[0.0C',5.0C']$ & 15.9 & 0.050 & 0.321 & 15.9 & 0.050 & 0.292 & 16.0 & 0.100 & 0.728 & 15.9 & 0.050 & 1.434 \\
      ...
      \multirow{6}{*}{0.3} & $U[0.0C',0.5C']$ & 16.8 & 0.100 & 0.355 & 17.0 & 0.100 & 0.308 & \textbf{16.6} & 0.100 & 0.681 & 17.3 & 0.050 & 1.108 \\
       & $U[0.5C',1.0C']$ & \textbf{16.1} & 0.050 & 0.315 & 16.3 & 0.050 & 0.283 & 16.3 & 0.050 & 0.660 & \textbf{16.2} & 0.000 & 1.362 \\
       & $U[1.0C',4.0C']$ & \textbf{15.8} & 0.000 & 0.296 & 15.9 & 0.050 & 0.310 & \textbf{15.8} & 0.000 & 0.740 & \textbf{15.9} & 0.050 & 1.449 \\
      ...
      TTRecolored & TabuTenure & $\overline{obj}$ & $sd$ & $\overline{time}$ & $\overline{obj}$ & $sd$ & $\overline{time}$ & $\overline{obj}$ & $sd$ & $\overline{time}$ & $\overline{obj}$ & $sd$ & $\overline{time}$\\
      \hline
      \multirow{6}{*}{0.0} & $U[0.0C',0.5C']$ & \textbf{8.1} & 0.027 & 0.088 & 8.2 & 0.044 & 0.084 & \textbf{8.1} & 0.038 & 0.272 & 8.2 & 0.077 & 0.682 \\
       & $U[0.5C',1.0C']$ & \textbf{8.0} & 0.038 & 0.081 & \textbf{8.0} & 0.038 & 0.083 & \textbf{8.0} & 0.055 & 0.280 & \textbf{8.0} & 0.033 & 0.732 \\
       & $U[1.0C',4.0C']$ & 7.9 & 0.016 & 0.085 & \textbf{7.9} & 0.022 & 0.084 & \textbf{7.9} & 0.016 & 0.297 & \textbf{7.9} & 0.022 & 0.757 \\
       & $U[0.0C',5.0C']$ & 7.9 & 0.016 & 0.084 & 7.9 & 0.022 & 0.089 & 7.9 & 0.016 & 0.305 & 7.9 & 0.005 & 0.737 \\
       & $U[5.0C',10.0C']$ & \textbf{7.9} & 0.022 & 0.089 & \textbf{7.9} & 0.027 & 0.088 & 8.0 & 0.033 & 0.300 & 8.0 & 0.016 & 0.730 \\
       & $U[10.0C',20.0C']$ & 8.1 & 0.027 & 0.087 & \textbf{8.0} & 0.027 & 0.092 & \textbf{8.0} & 0.027 & 0.290 & \textbf{8.0} & 0.022 & 0.721 \\
      \hline\hline
      \multirow{6}{*}{0.3} & $U[0.0C',0.5C']$ & \textbf{8.1} & 0.061 & 0.086 & \textbf{8.1} & 0.038 & 0.085 & 8.2 & 0.055 & 0.271 & 8.2 & 0.038 & 0.705 \\
       & $U[0.5C',1.0C']$ & \textbf{8.0} & 0.066 & 0.083 & \textbf{8.0} & 0.033 & 0.080 & \textbf{8.0} & 0.027 & 0.285 & \textbf{8.0} & 0.044 & 0.748 \\
       & $U[1.0C',4.0C']$ & 7.9 & 0.016 & 0.082 & \textbf{7.9} & 0.027 & 0.085 & \textbf{7.9} & 0.016 & 0.298 & \textbf{7.9} & 0.011 & 0.749 \\
       & $U[0.0C',5.0C']$ & 7.9 & 0.011 & 0.083 & \textbf{7.8} & 0.011 & 0.085 & 7.9 & 0.027 & 0.291 & 7.9 & 0.027 & 0.760 \\
       & $U[5.0C',10.0C']$ & \textbf{7.9} & 0.011 & 0.090 & 8.0 & 0.022 & 0.087 & \textbf{7.9} & 0.027 & 0.298 & \textbf{7.9} & 0.027 & 0.754 \\
      ...
      TTRecolored & TabuTenure & $\overline{obj}$ & $sd$ & $\overline{time}$ & $\overline{obj}$ & $sd$ & $\overline{time}$ & $\overline{obj}$ & $sd$ & $\overline{time}$ & $\overline{obj}$ & $sd$ & $\overline{time}$\\
      \hline
      \multirow{6}{*}{0.0} & $U[0.0C',0.5C']$ & 7.6 & 0.100 & 0.062 & 7.6 & 0.100 & 0.064 & 7.6 & 0.100 & 0.291 & 7.8 & 0.100 & 0.831 \\
       & $U[0.5C',1.0C']$ & 7.6 & 0.100 & 0.061 & 7.7 & 0.050 & 0.058 & 7.7 & 0.050 & 0.263 & 7.7 & 0.050 & 0.862 \\
       & $U[1.0C',4.0C']$ & 7.7 & 0.050 & 0.058 & 7.3 & 0.150 & 0.066 & 7.5 & 0.150 & 0.294 & 7.3 & 0.050 & 0.964 \\
       & $U[0.0C',5.0C']$ & \textbf{7.2} & 0.100 & 0.074 & 7.4 & 0.100 & 0.064 & 7.2 & 0.100 & 0.309 & 7.3 & 0.050 & 0.959 \\
       & $U[5.0C',10.0C']$ & 7.7 & 0.050 & 0.061 & \textbf{7.5} & 0.150 & 0.063 & 7.5 & 0.050 & 0.280 & 7.7 & 0.050 & 0.831 \\
       & $U[10.0C',20.0C']$ & 7.9 & 0.050 & 0.062 & 7.8 & 0.000 & 0.062 & 7.8 & 0.000 & 0.272 & 7.8 & 0.000 & 0.840 \\
      \hline\hline
      \multirow{6}{*}{0.3} & $U[0.0C',0.5C']$ & 7.6 & 0.100 & 0.058 & 7.7 & 0.050 & 0.055 & 7.6 & 0.100 & 0.272 & 7.7 & 0.050 & 0.856 \\
       & $U[0.5C',1.0C']$ & 7.6 & 0.100 & 0.060 & 7.7 & 0.050 & 0.058 & 7.7 & 0.050 & 0.270 & 7.8 & 0.000 & 0.857 \\
       & $U[1.0C',4.0C']$ & 7.4 & 0.100 & 0.070 & \textbf{7.2} & 0.100 & 0.075 & 7.2 & 0.100 & 0.308 & 7.5 & 0.150 & 0.881 \\
       & $U[0.0C',5.0C']$ & 7.3 & 0.150 & 0.070 & 7.2 & 0.100 & 0.072 & 7.2 & 0.000 & 0.306 & 7.3 & 0.050 & 0.960 \\
       & $U[5.0C',10.0C']$ & 7.6 & 0.100 & 0.062 & 7.7 & 0.050 & 0.059 & 7.7 & 0.050 & 0.272 & 7.6 & 0.000 & 0.889 \\
      ...
      TTRecolored & TabuTenure & $\overline{obj}$ & $sd$ & $\overline{time}$ & $\overline{obj}$ & $sd$ & $\overline{time}$ & $\overline{obj}$ & $sd$ & $\overline{time}$ & $\overline{obj}$ & $sd$ & $\overline{time}$\\
      \hline
      \multirow{6}{*}{0.0} & $U[0.0C',0.5C']$ & \textbf{8.6} & 0.000 & 0.131 & \textbf{8.7} & 0.050 & 0.119 & \textbf{8.7} & 0.050 & 0.459 & \textbf{8.7} & 0.050 & 1.402 \\
       & $U[0.5C',1.0C']$ & 8.7 & 0.050 & 0.120 & 8.8 & 0.100 & 0.108 & \textbf{8.6} & 0.000 & 0.457 & 8.7 & 0.050 & 1.432 \\
       & $U[1.0C',4.0C']$ & \textbf{8.6} & 0.000 & 0.117 & \textbf{8.5} & 0.050 & 0.124 & 8.7 & 0.050 & 0.433 & 8.6 & 0.000 & 1.473 \\
       & $U[0.0C',5.0C']$ & \textbf{8.6} & 0.000 & 0.125 & 8.6 & 0.000 & 0.120 & 8.6 & 0.000 & 0.447 & 8.6 & 0.000 & 1.461 \\
       & $U[5.0C',10.0C']$ & 8.7 & 0.050 & 0.126 & 8.7 & 0.050 & 0.125 & 8.9 & 0.050 & 0.422 & 8.8 & 0.000 & 1.367 \\
       & $U[10.0C',20.0C']$ & 9.0 & 0.000 & 0.114 & 9.0 & 0.000 & 0.113 & 9.0 & 0.000 & 0.415 & 8.9 & 0.050 & 1.372 \\
      \hline\hline
      \multirow{6}{*}{0.3} & $U[0.0C',0.5C']$ & 8.7 & 0.050 & 0.119 & 8.8 & 0.100 & 0.118 & 8.8 & 0.100 & 0.409 & \textbf{8.7} & 0.050 & 1.393 \\
       & $U[0.5C',1.0C']$ & 8.7 & 0.050 & 0.115 & 8.8 & 0.100 & 0.114 & 8.7 & 0.050 & 0.445 & \textbf{8.6} & 0.000 & 1.440 \\
       & $U[1.0C',4.0C']$ & \textbf{8.6} & 0.000 & 0.123 & \textbf{8.5} & 0.050 & 0.115 & \textbf{8.6} & 0.000 & 0.433 & 8.6 & 0.000 & 1.421 \\
       & $U[0.0C',5.0C']$ & \textbf{8.6} & 0.000 & 0.122 & 8.6 & 0.000 & 0.115 & 8.6 & 0.000 & 0.442 & \textbf{8.5} & 0.050 & 1.514 \\

...
\cline{1-14}
 nodes & density   & $\overline{obj}$ & $sd$ & $\overline{time}$  & $obj$ & $sd$ & $time$  & $obj$ & $sd$ & $time$  & $obj$ & $sd$ & $time$\\
\hline
20 & 0.5   & \textbf{3.00} & 0.00 & 0.01   & \textbf{3.00} & 0.00 & 0.07  & \textbf{3.00} & 0.00 & 0.11  & \textbf{3.00} & 0.00 & 0.12\\
40 & 0.5   & \textbf{4.00} & 0.00 & 0.02   & \textbf{4.00} & 0.00 & 0.05  & \textbf{4.00} & 0.00 & 0.14   & \textbf{4.00} & 0.00 & 0.22\\
60 & 0.5   & \textbf{5.00} & 0.00 & 0.06   & \textbf{5.00} & 0.00 & 0.09  & \textbf{5.00} & 0.00 & 0.25   & \textbf{5.00} & 0.00 & 0.47\\
70 & 0.5   & \textbf{6.00} & 0.00 & 0.08   & \textbf{6.00} & 0.00 & 0.08  & \textbf{6.00} & 0.00 & 0.21   & \textbf{6.00} & 0.00 & 0.47\\
80 & 0.5   & 6.27 & 0.13 & 0.15  & \textbf{6.21} & 0.15 & 0.18  & 6.26 & 0.15 & 0.34   & \textbf{6.21} & 0.15 & 0.75\\
90 & 0.5   & \textbf{7.88} & 15.47 & 0.36  & 7.91 & 15.54 & 0.38 & \textbf{7.88} & 15.52 & 0.59   & 7.91 & 15.54 & 1.08\\
100 & 0.5   & 7.12 & 0.01 & 0.32   & 7.22 & 0.15 & 0.32  & 7.23 & 0.15 & 0.53   & \textbf{7.00} & 0.00 & 1.35\\
120 & 0.5   & 8.64 & 0.19 & 0.52   & 8.64 & 0.24 & 0.64  & 8.62 & 0.24 & 0.85   & \textbf{8.60} & 0.24 & 1.89\\
\hline
\end{tabular}
}
\end{table}
...
90 & 0.5  & 6 & 7  & 7.88 & 15.47 & 0.36  & \textbf{7.55} & 0.50 & 7.49 \\
...
\hline
90 & 0.1   & \textbf{3.00} & 0.00 & 0.02   & \textbf{3.00} & 0.00 & 0.11  & \textbf{3.00} & 0.00 & 0.16 & \textbf{3.00} & 0.00 & 0.36\\
90 & 0.2   & \textbf{3.80} & 0.15 & 0.03   & \textbf{3.80} & 0.15 & 0.06  & \textbf{3.80} & 0.15 & 0.15 & \textbf{3.80} & 0.15 & 0.51\\
90 & 0.3   & \textbf{5.00} & 0.00 & 0.06   & \textbf{5.00} & 0.00 & 0.06  & \textbf{5.00} & 0.00 & 0.17 & \textbf{5.00} & 0.00 & 0.43\\
90 & 0.4   & \textbf{6.00} & 0.00 & 0.11   & \textbf{6.00} & 0.00 & 0.11  & \textbf{6.00} & 0.00 & 0.26 & \textbf{6.00} & 0.00 & 0.59\\
90 & 0.5   & \textbf{7.00} & 0.00 & 0.18   & \textbf{7.00} & 0.00 & 0.19  & \textbf{7.00} & 0.00 & 0.39  & \textbf{7.00} & 0.00 & 0.84\\
90 & 0.6   & 8.28 & 0.15 & 0.31   & 8.40 & 0.24 & 0.36  & \textbf{8.20} & 0.16 & 0.58 & 8.40 & 0.24 & 1.03\\
90 & 0.7   & \textbf{10.00} &0.00 & 0.45   & \textbf{10.0} & 0.00 & 0.45  & \textbf{10.00} & 0.00 & 0.73   & \textbf{10.00} & 0.00 & 1.25\\
90 & 0.8   & \textbf{12.05} & 0.01 & 0.80   & 12.20 & 0.15 & 0.77  & 12.20 & 0.15 & 1.16 & 12.20 & 0.15 & 1.83\\
90 & 0.9   & \textbf{15.80} & 0.15 & 1.23   & \textbf{15.80} & 0.15 & 1.26  & \textbf{15.80} & 0.15 & 1.62 & \textbf{15.80} & 0.15 & 2.27\\
\hline
\end{tabular}
}
\end{table}
...
\begin{itemize}
\item todo on sunday: compare to Noronha, Ribiero
\end{itemize}
\end{frame}

...
//        }
//        this.selectedColoredNCIs = new HashSet<NodeColorInfoIF>(this.nodeColorInfo.length);
//        this.selectedUncoloredNCIs = new HashSet<NodeColorInfoIF>(this.nodeColorInfo.length);
//        this.unselectedNCIs = new HashSet<NodeColorInfoIF>(Arrays.asList(nodeColorInfo));
//        this.conflictingNCIs = new HashSet<NodeColorInfoIF>(this.nodeColorInfo.length);//ncis that should be recolored
//    }
//
//    /*
//     * copy constructor
...
//        }
//        this.unselectedNCIs = new HashSet<NodeColorInfoIF>(this.nodeColorInfo.length);
//        for (NodeColorInfoIF nciOrig : c.getUnselectedNCIs()) {
//            NodeColorInfo nciCopy = nodeColorInfo[nciOrig.getNode().getId()];
//            unselectedNCIs.add(nciCopy);
//        }
//        this.conflictingNCIs = new HashSet<NodeColorInfoIF>(this.nodeColorInfo.length);
